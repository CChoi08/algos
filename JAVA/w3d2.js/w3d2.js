...
class MinHeap {
  ...
  extract() {
    ...
    //swap last index with min index and pop
    var temp = this.heap[lastIndex];
    this.heap[lastIndex] = this.heap[1];
    this.heap[1] = temp;
    this.heap.pop();
    
    //current starts at min index
    var current = 1;

    //while current index is larger than left child OR right child
    while (this.heap[current] > this.heap[current * 2] || this.heap[current] > this.heap[current * 2 + 1]) {
      //if right child is smaller than left, swap current with right child
      ...
      //if left child is smaller than right, swap current with left child
      else {
