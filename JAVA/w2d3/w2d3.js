...
insertRecursive(newVal, curr = this.root) {
    if(curr === null) {
        ...
        if (newVal < curr) {
            this.root.left = this.insertRecursive(curr.left, newVal);
        } else {
            curr.right = this.insertRecursive(curr.right, newVal);
        }
        return curr;
    }
}
...
twoLevelTree.insertRecursive(1);
...
threeLevelTree.insert(9);
threeLevelTree.insert(6);
threeLevelTree.insert(4);
